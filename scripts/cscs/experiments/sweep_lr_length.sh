...
#   0..3 length axis {200,400,800,1600} @ lr 2e-5   (~0.26 .. ~2.1 epochs)
#   4..7 low-LR-for-longer: {1e-5,5e-6} x {800,1600} steps
set -euo pipefail
mkdir -p logs
...
LRS=(2e-5 2e-5 2e-5 2e-5 1e-5 1e-5 5e-6 5e-6)
STS=(200  400  800  1600 800  1600 800  1600)
